...
const HomeInsurance = () => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate('/homepolicy', { state: formData });
  };
  ...
  return (
    <div className="form-container1">
      <div className="image-container1">
        <img
          src={'https://res.cloudinary.com/duj7wgdt8/image/upload/v1689262768/vda5yy1ng25pss05wxgf-removebg-preview_lzen5h.png'}
          alt="Insurance"
        />
      </div>
      <div className="form-content1">
        <h1>
          Get upto <span className="blue">50% discount </span> on all home insurances
        </h1>
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group1">
            <label htmlFor="policyProvider">Owner/Tenent</label>
            <select id="policyProvider" name="policyProvider" value={formData.policyProvider} onChange={handleChange} required>
              <option value="">Select</option>
              <option value="provider1">Owner</option>
              <option value="provider2">Tenant</option>
          ...
          <div className="form-group1">
            <label htmlFor="value">Value of the building:</label>
